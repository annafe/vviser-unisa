...
<style type="text/css">
body{color:white;height:530px;}
nav{padding-top:0px;
	background-color:white;
	text-align:left;}
section#container-section{background-color:MEDIUMAQUAMARINE;font-size:12pt;word-wrap:break-word; padding-left:15px;
								padding-right:15px;
								width:670px;
								height:250px;
					padding-top:10px;
...
<section id="container-section">
	fbdsfhbgfgdsjbgfdshdbhasdvhasdvhjasdvhjvsfhdvsafvsfhfgvdsyafgvdyufgdsyuafgadsufgasudfgayudsgfayudsfsfgdsyaugfydsugfudsgfyuuuuuu
</section>
