...
*
*/
public class VisualizzaProdottiValidatiDipartimentoServlet extends HttpServlet {
		...
		private void processRequest(HttpServletRequest request,HttpServletResponse response)
		{
			...
			try
			{
				...
				ArrayList<Prodotto> pr=gp.visualizzaProdottivalidatiDipartimento();
				request.setAttribute("listaprodottidipartimento",pr);
